...
CHUNKS_LOG = os.path.expanduser("~/Documents/supreme-court-rag/data/question_chunks.txt")
ANSWERS_LOG = os.path.expanduser("~/Documents/supreme-court-rag/data/question_answers.txt")
